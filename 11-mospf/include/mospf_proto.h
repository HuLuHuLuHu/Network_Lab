...
static inline struct mospf_hdr *packet_to_mospf_hdr(const char *packet)
{
	return (struct mospf_hdr *)((char *)packet + ETHER_HDR_SIZE + IP_HDR_SIZE(packet_to_ip_hdr(packet)));
}
#endif
